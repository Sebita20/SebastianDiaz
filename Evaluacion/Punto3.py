...
# ListNombre = []
# for jedi in jedis:
#     ListNombre.append(jedi["name"])
# print(ListNombre)

for jedi in jedis:
    if jedi["name"] == "Ahsoka Tano":
        print(f"""
Informacion de Ahsoka Tano: """, jedi)
    if jedi["name"] == "Kit Fisto":
        print(f"""
Informacion de Kit Fisto: """, jedi)
...
print(f"Padawans de Luke: ", PadawansLuke)
print(f"Padawans de Yoda: ", PadawansYoda)
...
print(f"Los jedis de especie humana son: ", Humanos)
print(f"Los jedis de especie twi'lek son: ", twilek)

jedis_A = []
for jedi in jedis: 
    if jedi["name"][0] == "A": 
        jedis_A.append(jedi["name"])
print(f"Los jedis que empiezan con A son: ", jedis_A)

SableAmarillo = []
SableMorado = []
for jedi in jedis:
    if jedi["lightsaber_color"] == "Yellow":
        SableAmarillo.append(jedi["name"])
    if jedi["lightsaber_color"] == "Purple":
        SableAmarillo.append(jedi["name"])
print(f"Sable laser amarillo: ", SableAmarillo)
print(f"Sable laser morado: ", SableMorado)
...
for jedi in jedis:
    ...
    if jedi["master"] == "Mace Windu":
        PadawansMaceWindu.append(jedi["name"])
print(f"Padawans de Qui-Gon Jin: ", PadawansQuiGon)
print(f"Padawans de Mace Windu : ", PadawansMaceWindu)

GrandMaster = []
for jedi in jedis: 
    if jedi["rank"] == "Grand Master": 
        GrandMaster.append(jedi["name"])
print(f"jedi grand master: ", GrandMaster)