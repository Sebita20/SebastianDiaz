...
for personajes in super_heroes: 
    if personajes ['is_hero'] == False:
        villanos.insert_node(personajes['nombre'], personajes)
    else:
        tree.insert_node(personajes['nombre'], personajes)
        heroes.insert_node(personajes['nombre'], personajes)

lista_villanos = villanos.inorden_villanos()
...
print("----------------------")
nodos_villanos = villanos.contar_nodos()
nodos_heroes = heroes.contar_nodos()
print("El árbol de villanos tiene", nodos_villanos, "nodos")
